  ...
  return (
    <Stack alignItems="center" mt="37px" justifyContent="center" padding="20px">
      <Typography fontWeight="700" sx={{fontSize: {lg: '44px', xs: "30px"}}}  mb='50px' textAlign="center">
          Awesome Exercises You <br/> Shold Know
      </Typography>
      <Box position="relative" mb="72px">
        ...
        <Button className="search-btn" sx={{
          backgroundColor: '#ff2625', color: '#fff', textTransform: 'none', fontSize: {lg: '20px', xs: '14px'},
          width:{lg: '165px', xs: '65px'}, height: '56px', position: 'absolute', right: '0' 
